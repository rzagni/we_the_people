...
class AppConnector {
  ...
  CreateSurveyVariablesBuilder createSurvey ({required String id, required String question, required SurveyStatus status, required String createdBy, }) {
    return CreateSurveyVariablesBuilder(dataConnect, id: id,question: question,status: status,createdBy: createdBy,);
  }
  ...
  CreateSurveyDeliveryVariablesBuilder createSurveyDelivery ({required String id, required String surveyId, required String userId, required String deviceId, required DeliveryStatus status, }) {
    return CreateSurveyDeliveryVariablesBuilder(dataConnect, id: id,surveyId: surveyId,userId: userId,deviceId: deviceId,status: status,);
  }
